...
import { CalendarHeart, HeartHandshake, MessagesSquare, ShieldCheck, Users, X } from 'lucide-react'
...
const items: { id: ScreenId; label: string; icon: typeof CalendarHeart }[] = [
  ...
  { id: 'chat', label: 'Caregivers Chat', icon: MessagesSquare },
]
    ...
    <>
      ...
      >
        <div className="flex items-start justify-between px-2">
          <div>
            ...
            <p className="mt-3 text-sm leading-relaxed text-sidebar-foreground/70">
              Caring for Mama, together — without taking over her life.
            </p>
          </div>
          <button
            type="button"
        ...
        <div className="mt-auto rounded-2xl bg-sidebar-accent/60 p-4 text-sm leading-relaxed text-sidebar-foreground/80">
          <p className="font-medium text-sidebar-foreground">You are the main caregiver</p>
          <p className="mt-1 text-sidebar-foreground/70">
            You see what Fatima has chosen to share. Some things stay private to her.
          </p>
        </div>
      </aside>
    </>
